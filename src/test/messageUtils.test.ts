...
describe("messageUtils", () => {
  ...
  describe("showErrorMessage", () => {
    ...
    it("forwards different messages correctly", () => {
      ...
      expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Another error");
    });
  });
  ...
  describe("showWarningMessage", () => {
    it("calls vscode.window.showWarningMessage with the given message", () => {
      ...
      expect(vscode.window.showWarningMessage).toHaveBeenCalledWith("Proceeding with caution");
    });
  });
});
